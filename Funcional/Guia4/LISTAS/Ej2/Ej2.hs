...
--Durante un entrenamiento físico de una hora, cada 10 minutos de entrenamiento se tomó la frecuencia cardíaca de uno de 
--los participantes obteniéndose un total de 7 muestras que son las siguientes:
...
frecuenciaCardiaca = [80, 100, 120, 128, 130, 123, 125]
promedioFrecuenciaCardiaca :: (Num a, Fractional a) => a
...
frecuenciaCardiacaMinuto =  (frecuenciaCardiaca !!) . flip div 10

--c.
frecuenciasHastaMomento :: Int -> [Int]
frecuenciasHastaMomento = (`take` frecuenciaCardiaca) . flip div 10